...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--input-summary",
        type=Path,
        default=Path("/home/filip/digital_drn/cases/conv_cases/cifar10_wider_hardsigmoid_ep_bp_100epochs/summary.json"),
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("/home/filip/digital_drn/cases/conv_cases/cifar10_wider_hardsigmoid_iteration_sweep"),
    )
