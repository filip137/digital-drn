...
def _make_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Train the widened hard-sigmoid CIFAR config for 100 epochs under BP first and then EP, then diagnose BP-vs-EP agreement."
    )
...
def main() -> int:
    ...
    summary: dict[str, object] = {
        ...
        "algorithm_order": ["bp", "ep"],
        "rows": [],
    }

    for algorithm_name in ("bp", "ep"):
